...
class AllMapIconsPatch
{
    ...
    public static void Postfix_AllMapIcons(GameStartManager __instance)
    {
        ...
        DleksIncon.MapImage = Utils.LoadSprite($"FinalSuspect_Xtreme.Resources.Images.DleksBanner.png", 100f);
        DleksIncon.NameImage = Utils.LoadSprite($"FinalSuspect_Xtreme.Resources.Images.DleksBanner-Wordart.png", 100f);
...
public static class VentSetButtonsPatch
{
    ...
    {
        if (!XtremeGameData.GameStates.DleksIsActive) return;
