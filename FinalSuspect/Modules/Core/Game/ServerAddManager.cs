...
public static class ServerAddManager
{
    ...
    private static Color GetServerColor(string serverName)
    {
        ...
        {
            "Asia" or "Europe" or "North America" => new Color32(58, 166, 117, 255),
            "Modded Asia (MAS)" or "Modded NA (MNA)" or "Modded EU (MEU)" => new Color32(255, 132, 0, 255),
            ...
            "Niko233(NA)" or "Niko233(AS)" or "Niko233(EU)" or "Niko233(CN)" => new Color32(255, 224, 0, 255),
